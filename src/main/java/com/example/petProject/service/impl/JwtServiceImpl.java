...
public class JwtServiceImpl implements JwtService {
    ...
    private Map<String, Object> generateClaim(User userDetails) {
        String authorities = userDetails.getAuthorities().stream()
                .map(GrantedAuthority::getAuthority)
                .collect(Collectors.joining(","));
        Map<String, Object> claim = new HashMap<>();
        claim.put(AUTHORITIES_KEY, authorities);
//        claim.put(MODULES, userDetails.getModules());
        return claim;
    }

    @Override
    public String generateToken(User userDetails) {
        Map<String, Object> claim = generateClaim(userDetails);
    ...
    public String generateRefreshToken(
        ...
        Map<String, Object> claim = generateClaim(userDetails);
        return buildToken(claim, userDetails, refreshExpiration);
    }
}
